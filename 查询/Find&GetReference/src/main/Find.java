...
public class Find {
    ...
    public static void main(String[] args) {
        ...
        // 查找对象；立即检索。与getReference方法不同的是getReference是延迟检索。
        AccountInfoEntity accountInfoEntity = entityManager.find(AccountInfoEntity.class, BigInteger.valueOf(1L));
...
Hibernate:
    ...
    where
        accountinf0_.id=?
main.entities.AccountInfoEntity
------
